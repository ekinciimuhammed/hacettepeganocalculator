/* Split from pdf-motoru.js */
Object.assign(PDFIsleyici.prototype, {
    ...
    setupToolOptions(toolName) {
        ...
        switch (toolName) {
            case 'pdf-to-png':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <label>İndirme Seçenekleri</label>
                        <select id="download-option">
                            <option value="zip">Tüm sayfaları ZIP dosyası olarak indir</option>
                            <option value="individual">İndirmek için tek tek sayfaları göster</option>
                        </select>
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Dönüştürülen PNG görsellerini nasıl indirmek istediğinizi seçin.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'edit-metadata':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <p>Standart PDF meta verilerini düzenleyin. Değiştirmek istemediğiniz alanları boş bırakın. Tüm meta verileri silmek için Metadata Sil aracını kullanın.</p>
                    </div>
                    <div class="option-group">
                        <label for="meta-title">Başlık</label>
                        <input id="meta-title" type="text" placeholder="Belge Başlığı" />
                    </div>
                    <div class="option-group">
                        <label for="meta-author">Yazar</label>
                        <input id="meta-author" type="text" placeholder="Yazar Adı" />
                    </div>
                    <div class="option-group">
                        <label for="meta-subject">Konu</label>
                        <input id="meta-subject" type="text" placeholder="Subject" />
                    </div>
                    <div class="option-group">
                        <label for="meta-keywords">Anahtar Kelimeler</label>
                        <input id="meta-keywords" type="text" placeholder="Virgülle ayrılmış (örn. proje, rapor, 1. Çeyrek)" />
                    </div>
                    <div class="option-group">
                        <label for="meta-producer">Üretici</label>
                        <input id="meta-producer" type="text" placeholder="PDF Üreticisi" />
                    </div>
                    <div class="option-group">
                        <label for="meta-creator">Oluşturan</label>
                        <input id="meta-creator" type="text" placeholder="Uygulama veya araç adı" />
                    </div>
                    <div class="option-group">
                        <label for="meta-language">Dil</label>
                        <input id="meta-language" type="text" placeholder="örn. tr, tr-TR, en-US" />
                    </div>
                    <div class="option-group">
                        <label for="meta-creation-date">Oluşturulma Tarihi</label>
                        <input id="meta-creation-date" type="datetime-local" />
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.25rem;">Ayarlanırsa, PDF'in oluşturulma tarihini geçersiz kılar.</p>
                    </div>
                    <div class="option-group">
                        <label for="meta-modification-date">Değiştirilme Tarihi</label>
                        <input id="meta-modification-date" type="datetime-local" />
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.25rem;">Ayarlanırsa, PDF'in değiştirilme tarihini geçersiz kılar.</p>
                    </div>
                `;
            ...
            case 'pdf-to-jpeg':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        ...
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Dönüştürülen JPEG görsellerini nasıl indirmek istediğinizi seçin.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'svg-to-png':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        ...
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Yüklenen her SVG, tarayıcınızda yerel olarak PNG görseline dönüştürülecektir.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'svg-to-jpeg':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <label>Seçenekler</label>
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Yüklenen her SVG, tarayıcınızda yerel olarak beyaz arka plana sahip JPEG görseline dönüştürülecektir.
                        </p>
                    </div>
                `;
                break;
                ...
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        ...
                        <select id="conversion-mode">
                            <option value="combined">Tüm görselleri tek PDF olarak birleştir</option>
                            <option value="individual">Ayrı PDF dosyaları (ZIP + Tekil Kullanım)</option>
                        </select>
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Görsellerinizin PDF formatına nasıl dönüştürülmesini istediğinizi seçin.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'webp-to-png':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <label>Seçenekler</label>
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Yüklenen her WEBP, tarayıcınızda yerel olarak PNG görseline dönüştürülecektir.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'webp-to-jpeg':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <label>Seçenekler</label>
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Yüklenen her WEBP, tarayıcınızda yerel olarak beyaz arka plana sahip JPEG görseline dönüştürülecektir.
                        </p>
                    </div>
                `;
                break;
                ...
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <p style="font-size: 0.95rem; color: rgba(248, 250, 252, 0.8); margin: 0;">
                            Ayar yapmanıza gerek yok. Tüm sayfalar otomatik olarak dikey bir PDF'e dönüştürülecektir.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'rotate-pdf':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        ...
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Tüm sayfalar seçilen açıyla döndürülecektir.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'compress-pdf':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <p>"Dosyaları İşle" butonuna tıklayarak PDF dosyanızı sıkıştırın.</p>
                    </div>
                `;
                break;
            ...
            case 'compress-image':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <p>"Dosyaları İşle" butonuna tıklayarak resimlerinizi sıkıştırın.</p>
                    </div>
                `;
                break;
                ...
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        ...
                        <select id="resize-mode">
                            <option value="percentage">Yüzdeye Göre</option>
                            <option value="resolution-lock">Çözünürlüğe Göre (En Boy Oranını Koru)</option>
                            <option value="resolution-free">Çözünürlüğe Göre (Serbest Boyut)</option>
                        </select>
                    </div>
                    <div class="option-group" id="resize-percentage-group">
                        <label for="resize-percentage">Yeniden Boyutlandırma Yüzdesi</label>
                        <div class="resize-inline-inputs">
                            <input type="number" id="resize-percentage" min="1" max="500" value="100">
                            <span>%</span>
                        </div>
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Örnek: %50 değeri, her görselin genişliğini ve yüksekliğini yarı yarıya küçültür.
                        </p>
                    </div>
            ...
            case 'remove-password':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        ...
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Bu PDF dosyasını açmak için gereken şifreyi girin.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'extract-pages':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        ...
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Çıkarılacak sayfaları belirtin. Tek sayfalar için virgül, aralıklar için tire kullanın.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'remove-pages':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        ...
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Silinecek sayfaları belirtin. Tek sayfalar için virgül, aralıklar için tire kullanın.
                        </p>
                    </div>
                `;
                break;
            ...
            case 'sort-pages':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <p>Sayfa sırasını değiştirmek için sürükleyip bırakabileceğiniz sayfa küçük resimlerini görmek adına bir PDF yükleyin.</p>
                        <div class="sort-controls" style="display: none; margin: 1rem 0; display: flex; flex-wrap: wrap; gap: .5rem; align-items: center;">
                            <button type="button" id="reverse-pages-btn" class="reverse-btn">
                                ...
                                Sıralamayı Tersine Çevir (Arkadan Öne)
                            </button>
                        ...
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            Sıralamayı değiştirmek için sayfa küçük resminde herhangi bir yere sürükleyin. Mobilde bir saniye kadar basılı tutup ardından sürükleyin.
                        </p>
                    </div>
                `;
                ...
                optionsContainer.innerHTML = `
                    <div class="watermark-layout">
                                ...
                                <div class="watermark-preview-panel">
                                    <div class="watermark-preview-shell" id="watermark-preview-shell">
                                        ...
                                        <div id="watermark-preview-empty" class="watermark-preview-empty">
                                            1. sayfada filigran yerleşimini önizlemek için bir PDF dosyası yükleyin.
                                        </div>
                                    </div>
                                </div>
                                <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.55rem;">
                                    Konumlandırmak için filigranı önizlemede sürükleyin. Görsel modunda, yeniden boyutlandırma tutamacı veya boyut alanlarını kullanın.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="watermark-controls-column">
                            <div class="option-group">
                                <label for="watermark-excluded-pages">Hariç Tutulacak Sayfalar (isteğe bağlı)</label>
                                <input type="text" id="watermark-excluded-pages" placeholder="Example: 6, 9, 12-14">
                                <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                                    Bu sayfalar atlanacak ve değiştirilmeyecektir.
                                </p>
                            </div>
                            ...
                            <div class="option-group" id="watermark-text-options">
                                <label for="watermark-text-input">Filigran Metni</label>
                                ...
                                <div class="watermark-input-grid">
                                    <div>
                                        <label for="watermark-text-color">Renk</label>
                                        <input type="color" id="watermark-text-color" value="#ba453c">
                                    </div>
                                    <div>
                                        <label for="watermark-text-font-size">Yazı Tipi Boyutu</label>
                                ...
                                <div class="watermark-input-grid">
                                    <div>
                                        <label for="watermark-text-font-family">Yazı Tipi</label>
                                    ...
                                    <div>
                                        <label for="watermark-text-font-style">Yazı Stili</label>
                            ...
                            <div class="option-group" id="watermark-image-options" style="display: none;">
                                <label for="watermark-image-file">Filigran Görseli</label>
                                <input type="file" id="watermark-image-file" accept=".png,.jpg,.jpeg,.webp,image/png,image/jpeg,image/webp">
                                <p id="watermark-image-selected" style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.7); margin-top: 0.35rem;">Görsel seçilmedi</p>

                                <div class="checkbox-group" style="margin-top: 0.65rem;">
                                    <input type="checkbox" id="watermark-image-centered" checked>
                                    <label for="watermark-image-centered">Görseli sayfada ortala</label>
                                </div>
                                ...
                                <div class="watermark-input-grid">
                                    <div>
                                        <label for="watermark-image-width">Genişlik</label>
                                        <input type="number" id="watermark-image-width" min="1" max="5000" value="220">
                                    </div>
                                    <div>
                                        <label for="watermark-image-height">Yükseklik</label>
            ...
            case 'flatten-pdf':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <p>Etkileşimli içeriği statik sayfa piksellerine düzleştirin. İşlem %100 tarayıcı tarafındadır.</p>
                    </div>
                `;
                break;
            ...
            case 'heif-to-pdf':
                optionsContainer.innerHTML = `
                    <div class="option-group">
                        <label>Conversion Mode</label>
                        <select id="conversion-mode">
                            <option value="individual">Ayrı PDF dosyaları (her HEIC/HEIF dosyası için ayrı)</option>
                            <option value="combined">Tümünü tek PDF'te birleştir</option>
                        </select>
                        <p style="font-size: 0.9rem; color: rgba(248, 250, 252, 0.6); margin-top: 0.5rem;">
                            HEIC/HEIF görsellerinizin PDF formatına nasıl dönüştürülmesini istediğinizi seçin.
                        </p>
                    </div>
                `;
                break;
    ...
    async renderWatermarkPreviewPage() {
        ...
        if (!pdfFile) {
            ...
            emptyState.textContent = '1. sayfada filigran yerleşimini önizlemek için bir PDF dosyası yükleyin.';
    ...
    updateImageResizerModeUI() {
        ...
        if (aspectHint) {
            aspectHint.textContent = mode === 'resolution-lock'
                ? 'En boy oranı kilidi açık. Genişliği veya yüksekliği düzenlediğinizde diğeri otomatik olarak güncellenir.'
                : 'En boy oranı kilidi kapalı. Genişlik ve yükseklik birbirinden bağımsızdır.';
        }
    ...
    async updateImageResizerReferenceDimensions() {
        ...
        if (!this.uploadedFiles.length) {
            ...
            originalHint.textContent = 'Boyutları otomatik doldurmak için bir görsel yükleyin.';
    ...
    updateProcessButton() {
        ...
        if (this.currentTool === 'add-watermark') {
            ...
            if (fileCount === 0) {
                ...
                processBtn.innerHTML = `
                    <i class="fas fa-stamp"></i>
                    Lütfen tam olarak 1 PDF seçin
                `;
            } else if (mode === 'image' && !hasImageAsset) {
                processBtn.innerHTML = `
                    <i class="fas fa-stamp"></i>
                    Filigran Görselini Seçin
                `;
            } else if (mode === 'image' && !validImageSize) {
                processBtn.innerHTML = `
                    <i class="fas fa-stamp"></i>
                    Görsel Boyutunu Düzeltin
                `;
            } else {
                processBtn.innerHTML = `
                    <i class="fas fa-stamp"></i>
            ...
            if (fileCount === 0) {
                ...
                processBtn.innerHTML = `
                    <i class="fas fa-cog"></i>
                    Tam olarak 2 PDF seçin (şu an ${fileCount})
                `;
            } else {
                processBtn.innerHTML = `
                    <i class="fas fa-cog"></i>
    ...
    showResults(results) {
        ...
        results.forEach(result => {
            ...
            resultItem.innerHTML = `
                ...
                <button class="download-btn" onclick="window.isleyici.downloadResult('${result.url}', '${result.name}')">
    ...
    async comparePdfs() {
        if (this.uploadedFiles.length !== 2) {
            throw new Error('Lütfen karşılaştırmak için tam olarak iki PDF dosyası yükleyin');
        }
        ...
        header.innerHTML = `
            <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; flex-wrap:wrap;">
                ...
                <div style="font-size:0.9rem; opacity:0.8;">Kırmızı alanlar görsel farklılıkları belirtir</div>
            </div>
        `;
        ...
        for (let i = 1; i <= pageCount; i++) {
            ...
            if (aInfo && bInfo) {
                ...
                note.textContent = aInfo ? 'Sağ tarafta eşleşen sayfa yok' : 'Sol tarafta eşleşen sayfa yok';
